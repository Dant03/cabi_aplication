...
//     double? tournamentNumCourts;
//     DateTime? tournamentRegistrationDate;
//     DateTime? tournamentStartDate;
//     double? tournamentRegistrationValue;
//     double? tournamentWarrantyValue;
//     double? tournamentMatchValue;
//     String? tournamentRules;
//     String? tournamentPhone;
//     String? tournamentEmail;
...
//         tournamentNumCourts: double.parse(json["tournament_num_courts"]),
...
//         tournamentRegistrationValue: double.parse(json["tournament_registration_value"]),
//         tournamentWarrantyValue: double.parse(json["tournament_warranty_value"]),
//         tournamentMatchValue: double.parse(json["tournament_match_value"]),
...
class TournamentModel {
    ...
    factory TournamentModel.fromJson(Map<String, dynamic> json) => TournamentModel(
        ...
        tournamentRegistrationDate: json["tournament_registration_date"] == null ? null : DateTime.parse(json["tournament_registration_date"]),
        tournamentStartDate: json["tournament_start_date"] == null ? null : DateTime.parse(json["tournament_start_date"]),
        tournamentRegistrationValue: json["tournament_registration_value"]?.toDouble(),
        tournamentWarrantyValue: json["tournament_warranty_value"]?.toDouble(),
        tournamentMatchValue: json["tournament_match_value"]?.toDouble(),
        tournamentRules: json["tournament_rules"],
        tournamentPhone: json["tournament_phone"],
        tournamentEmail: json["tournament_email"],
        tournamentStatus: json["tournament_status"],
        tournamentCreatedAt: json["tournament_created_at"] == null ? null : DateTime.parse(json["tournament_created_at"]),
        tournamentUpdatedAt: json["tournament_updated_at"] == null ? null : DateTime.parse(json["tournament_updated_at"]),
        teams: json["teams"] == null ? [] : List<TeamModel>.from(json["teams"]!.map((x) => TeamModel.fromJson(x))),
    );
